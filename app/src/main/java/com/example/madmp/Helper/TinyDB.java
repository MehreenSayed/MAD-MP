...
public class TinyDB {
    ...
    public ArrayList<CatDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<CatDomain> playerList =  new ArrayList<CatDomain>();

        for(String jObjString : objStrings){
            CatDomain player  = gson.fromJson(jObjString,  CatDomain.class);
    ...
    public void putListObject(String key, ArrayList<CatDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(CatDomain player: playerList){
